package procon.io.projeto2.config;
...
import procon.io.projeto2.repository.UserRepository;
...
public class DataInitializr implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		User user = userRepository.findByName("User3 Name3");

		System.out.println(user.getName());

		user = userRepository.findByNameIgnoreCaseLike("User3");

		System.out.println(user.getName());

		user = userRepository.findByEmailQualquerCoisa("user2");
